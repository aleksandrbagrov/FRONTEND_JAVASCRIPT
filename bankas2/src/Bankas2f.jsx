...
import AccountsFilter from './Components/Bankas1/AccountsFilter';
    ...
    return (
        <div className="App">
            <header className="App-header">
                ...
                <AccountsFilter radio={radio} setRadio={setRadio} />
