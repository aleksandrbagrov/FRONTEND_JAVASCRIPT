...
export default function Client({ client, setClient, setModalEnterActive, setModalDeleteActive, setModalClient, radio, setModalAddActive, setModalNotDeleteActive, setModalDeductActive, setModalNotDeductActive, setTransaction }) {
    ...
    return (
        <div className="client">
            ...
            <button type='button' className="red" onClick={delAcc}>Close an account</button>
            <div></div>
        </div>
    );
}
